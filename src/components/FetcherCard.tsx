  ...
  return (
    <div className={`w-full group h-[380px] grid grid-rows-2 rounded-3xl bg-gray-800 hover:bg-gradient-to-t hover:from-green-800 hover:to-green-400 p-10 hover:drop-shadow-2xl`}>
      <div className='w-full h-full grid place-content-center'>
        <div className='w-28 h-28 border-green-400 border group-hover:bg-gradient-to-b mb-4 from-emerald-600 to-green-400 rounded-full grid place-content-center'>
          {icon}
        </div>
      </div>
